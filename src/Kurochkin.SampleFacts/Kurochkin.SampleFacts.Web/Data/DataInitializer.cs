using Kurochkin.SampleFacts.Web.Infrastructure;
...
namespace Kurochkin.SampleFacts.Web.Data
{
    public static class DataInitializer
    {
        internal static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            var exists = context!.GetService<IDatabaseCreator>() is RelationalDatabaseCreator databaseCreator 
            ...
            const string userName = "dev@gmail.com";
